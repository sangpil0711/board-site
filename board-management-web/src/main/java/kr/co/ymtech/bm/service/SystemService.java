...
public class SystemService implements ISystemService {
	...
	public Integer createSystem(SystemDTO system) {
		...
		Integer checkKey = systemRepository.checkKey(system.getKey());
		...
		if (system.getKey() == null || system.getValue() == null || system.getDescription() == null) {
			...
			throw new IllegalArgumentException("시스템 프로퍼티 키 값이 중복되었습니다.");
		}
		else {
	 ...
	 *
	 * @see kr.co.ymtech.bm.service.ISystemService#findPage(java.lang.Integer,
	 *      java.lang.Integer)
	 *
