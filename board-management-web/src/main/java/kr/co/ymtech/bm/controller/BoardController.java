...
/**
 * 게시물 Controller 클래스
 *  객체에 데이터를 담아 반환해야 하니 RestController 사용
 */
@RestController
public class BoardController {
	 ...
	 * 
	 * @return :저장되어 있는 정보를 모두 변수 boardlist에 담고 ResponseEntity 를 사용하여 응답한다.  
	 * 			Http 상태코드는 HttpStatus.ok 로 성공상태 200을 나타내준다. 
	 */
	...
	/**
	 * Method : 게시물 내용(text)을 수정 하는 메소드이다.
	 * 
